...
\newcommand{\OrigSkillsEntry}[2]{\pagebreak[2]      % Same as \PersonalEntry
        \noindent\hangindent=2em\hangafter=0 % Indentation
        \parbox{\spacebox}{        % Box to align text
        \textit{#1}}               % Entry name (birth, address, etc.)
        \hspace{1.5em} \vspace{1.5em} \noindent \hangindent=2em \parbox{300px}{#2} \par}    % Entry value    
        
\newcommand{\SkillsEntry}[2]{\pagebreak[2]      % Same as \PersonalEntry
        \noindent\hangindent=2em\hangafter=0 % Indentation
        \parbox{\spacebox}{        % Box to align text
        \textit{#1}}               % Entry name (birth, address etc.)
        \hspace{1.5em} \vspace{1.5em}  \parbox{0.75\textwidth}{#2} \par}    % Entry value    
